<template>
  <div class="productdelte">
    <h2>Slet produktet</h2>
    <p>
                ...
                <b-col>
                  <div class="text-left">
                    ...
                    <b-tr>
                     ...
                     <b-tr>
                         <b-td></b-td>
                         <b-td><b-button @click="deleteProduct($event)" variant="danger" class="m-1">Slet produktet</b-button></b-td>
                     </b-tr>
                    </b-table-simple>
                  </div>
                </b-col>
...
export default {
  ...
  methods: {
    ...
    if(confirm('Er du sikker på du vil slette ?')) 
      this.$http
        .delete("https://followcasper.dk/api/productdelete/" + this.product_id, {
        })
        .then(res => {
          if (res.status == "200") {
            this.$router.push({
